...
export const pages: PageData[] = [
  {
    left: { type: 'cover', title: 'Mon Journal', subtitle: 'BUT Informatique S6', author: 'Ton Nom' },
    right: {
      type: 'intro',
      title: 'Coucou !',
  ...
  {
      left: { type: 'contact', title: 'On reste en contact ?' },
      right: { type: 'back-cover' }
  }
];

export const navigationLabels = ['Sommaire', 'Compétences', 'Contact'];
